function exiixte_usuario_modal(argument) {
	...
	let btn_existe_inicio_sesion =
		document.querySelector("#existe_usuario .btn_existe_inicio_sesion");
	let btn_existe_registrtrse =
		document.querySelector("#existe_usuario .btn_existe_registrtrse");

	btn_existe_inicio_sesion.addEventListener("click", function(argument) {
	...
	btn_existe_registrtrse.addEventListener("click", function(argument) {
		for (var i = 0; i < all_modal.length; i++) {
			all_modal[i].style.display = "none";
		}
